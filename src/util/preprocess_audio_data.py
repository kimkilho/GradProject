...
BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                        "..", "data")
DATA_DIR = os.path.join(BASE_DIR, "AudioFeatures_2016")
VALID_TAGS = "a"
...
#  diffSecs[4], l1Norm[5], l2Norm[6], linfNorm[7],
...
FEATURE_NAMES_DICT = {
  "a": ("l1Norm", "l2Norm", "linfNorm",)  # FIXME
}
...
if __name__ == "__main__":
  ...
  # [profile_id, timestamp, l1Norm(64), l2Norm(64), linfNorm(64), label]
